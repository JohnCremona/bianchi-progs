// Degeneracy maps, and new subspace function.  See Lingham's thesis
...
// I think these two are primes in the two non-trivial classes chosen
// so as to be coprime to all relevant levels.  It would be
// better to loop through all primes on the fly.
	 
	q1:=ideal<OK|197,w+137>;
        q2:=ideal<OK|197,w+59>;

// q is the standard prime representing the class [d]
        ...
        assert Determinant(M2) eq 1;    // i.e. a+c=1
